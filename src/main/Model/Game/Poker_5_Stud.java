...
public class Poker_5_Stud {
    ...
    public Poker_5_Stud() {
        ...
        hand1.add(new Card(Suit.Hearts, Rank.Ace));
        hand1.add(new Card(Suit.Hearts, Rank.Seven));
        hand1.add(new Card(Suit.Hearts, Rank.Seven));
        hand1.add(new Card(Suit.Hearts, Rank.Seven));
...
//        }
        ...
        hand2.add(new Card(Suit.Hearts, Rank.Seven));
        hand2.add(new Card(Suit.Hearts, Rank.Seven));
...
//        }
        ...
        //Outprint the hands
        for (Card c : r.sort_hand(hand1))
            System.out.println(c.toString());

        System.out.println("\n");

        for (Card c : r.sort_hand(hand2))
            System.out.println(c.toString());
        ...
        //Outprint the rank:
        System.out.println("Hand 1 has: " + (String.valueOf(Hand_Ranks.values()[Math.abs(r.rank_hand(hand1) - 10)])).replace("_", " "));
        System.out.println("Hand 2 has: " + String.valueOf(Hand_Ranks.values()[Math.abs(r.rank_hand(hand2) - 10)]).replace("_", " "));


        System.out.println("\n");


        int winner = r.compare_hands(hand1, hand2);
        if (winner == 1)
